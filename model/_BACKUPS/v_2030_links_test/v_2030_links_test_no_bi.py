# -*- coding: utf-8 -*-
"""
Created on Sat May  6 11:27:43 2023
...
for country in country_df['Bus name']:
    ...
    # n.add('Link',
    #       "Island to " + country,
    #       bus0              = bus_df.loc['Energy Island']['Bus name'],
    #       bus1              = country,
    #       p_min_pu          = 0,
    #       p_nom_extendable  = True,
    #       capital_cost      = tech_df['capital cost']['link'] * distance * DR,    #Capital cost is added here
    #       p_nom_max         = link_limit,
    #       p_nom_min         = link_p_nom_min,
    #       carrier           = 'link_' + country,
    #       )
