...
# j = 0
# for link_destination in link_destinations[1:]:         #i becomes each string in the array
#     j = j + 1
    
#     distance = gm.get_earth_distance(bus_df.loc['Energy Island']['X'],
#                                       country_df.loc[link_destination]['X'],
#                                       bus_df.loc['Energy Island']['Y'],
#                                       country_df.loc[link_destination]['Y'])
    
#     n.add(                        #Add component
#         "Link",                         #Component type
#         "Island_to_" + link_destination,               #Component name
#         bus0             = "Energy Island",    #Start Bus
#         bus1             = link_destination,           #End Bus
#         carrier          = "link_" + link_destination,        #Define carrier type
