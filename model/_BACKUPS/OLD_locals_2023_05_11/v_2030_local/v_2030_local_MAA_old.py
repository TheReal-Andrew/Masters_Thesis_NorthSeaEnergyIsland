...
for tech in techs:
    ...
    if tech == 'Store1' and not n.stores.e_nom_opt['Island_store'] == 0:
        
        capital_cost  = n.stores.capital_cost['Island_store']
        e_nom         = n.stores.e_nom_opt['Island_store']
        marginal_cost = n.stores.marginal_cost['Island_store']
        e_sum         = n.stores_t.e['Island_store'].sum()
