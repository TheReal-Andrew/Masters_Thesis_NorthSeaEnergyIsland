...
# Set limits, formatter, a horizontal line at zero, labels, and title for the original y-axis (dispatch)
...
axs.set_ylim([-4_000, 5_500])
axs.set_yticks(np.arange(-4_000, 7_000, 1_000), np.arange(-4, 7, 1))
...
tick_spacing = 1  # Set the desired tick spacing
